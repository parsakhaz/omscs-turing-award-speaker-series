		...
		<>
			...
			<article className='container mx-auto px-4 py-8 relative z-10'>
				<div className='max-w-4xl mx-auto bg-white bg-opacity-70 backdrop-filter backdrop-blur-lg rounded-lg p-4 md:p-8 shadow-lg'>
					<h1 className='text-3xl md:text-4xl font-bold mb-4 md:mb-6 text-[#a4925a]'>{advisor.name}</h1>
					...
					<p className='mb-3 md:mb-4 text-lg md:text-xl font-semibold text-gray-700'>{advisor.distinction}</p>
					<p className='mb-4 md:mb-6 ibm-plex-mono text-sm md:text-base text-gray-800'>{advisor.description}</p>
					<a
