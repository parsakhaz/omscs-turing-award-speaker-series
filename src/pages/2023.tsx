	...
	return (
		<>
			...
			<p className='justify-center text-center py-1 px-2 ibm-plex-mono text-white bg-slate-800'>
				The 2024 OMSCS Turing Award Series, hosted by{' '}
				<a href='https://www.linkedin.com/in/parsas/' className='italic underline' target='_blank'>
					Parsa Khazaeepoul
				</a>{' '}
				and{' '}
				<a href='https://www.linkedin.com/in/zackaxel/' className='italic underline' target='_blank'>
					Zach Axel
				</a>
				, has <span className='font-bold'>concluded.</span>
			</p>
              ...
              `,
					...
					<div className='mt-4 space-y-6'>
						...
						<div className='space-y-2'>
							...
							<p className='ibm-plex-mono'>
								For now, this is a one time event. If we have enough{' '}
								<a href='https://www.linkedin.com/in/parsas/' className='font-bold'>
									interest
								</a>
								, we may be able to make this recurring.
							</p>
						</div>
				...
				<section id='contact' className='my-12'>
					...
					<div className='mt-4 ibm-plex-mono'>
						<p className='pb-1'>
							We are two Online Master&apos;s in Computer Science student&apos;s at Georgia Tech. If you have any inquiries or need further information, please don&apos;t hesitate
							to contact us!
						</p>
						<div className='py-2'>
