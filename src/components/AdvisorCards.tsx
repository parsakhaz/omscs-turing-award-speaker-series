...
const AdvisorBio = ({ name, distinction, description, speakerPhoto, biographyLink, slug }: AdvisorBioProps) => {
	return (
		...
		>
			<Link href={`/advisor/${slug}`} className="absolute inset-0 z-0">
				...
				<div className="flex items-start space-x-4">
					...
					<div className="flex-1 min-w-0">
						...
						<a
							...
							target="_blank"
							rel="noreferrer"
							className="relative z-10 inline-flex items-center text-blue-600 hover:text-blue-800 text-sm font-medium"
						>
							View Biography →
						</a>
					</div>
